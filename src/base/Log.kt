...
object Log {
    ...
    fun v(tag: String, msg: String, e: Throwable? = null) {
        GlobalStorage.logger.trace(markerFor(tag), "{$tag}: $msg", e)
    }

    fun d(tag: String, msg: String, e: Throwable? = null) {
        GlobalStorage.logger.debug(markerFor(tag), "{$tag}: $msg", e)
    }

    fun i(tag: String, msg: String, e: Throwable? = null) {
        GlobalStorage.logger.info(markerFor(tag), "{$tag}: $msg", e)
    }

    fun w(tag: String, msg: String, e: Throwable? = null) {
        GlobalStorage.logger.warn(markerFor(tag), "{$tag}: $msg", e)
    }

    fun e(tag: String, msg: String, e: Throwable? = null) {
        GlobalStorage.logger.error(markerFor(tag), "{$tag}: $msg", e)
    }
}
